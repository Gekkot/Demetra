...
#include "../../demetraAdmin/requester.h"
...
QT_MOC_LITERAL(1, 10, 12), // "networkError"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "Requester\0networkError\0"
};
...
void Requester::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Requester::networkError)) {
                *result = 0;
            }
        }
    }
