 ...
 * @author gekko
 */
public class FoodSizeDao extends EntityDao<FoodSize>{
    
    public FoodSizeDao(ConnectionSource connectionSource) throws SQLException {
        super(FoodSize.class, connectionSource);
    }
